...
const Leaderboard = () => {
  ...
  const mockLeaderboardData = {
    week: [
      { rank: 1, name: 'Entrepreneur Erik', score: 12500, mapReached: 'Permit Palace' },
      { rank: 2, name: 'Startup Siri', score: 11200, mapReached: 'Tax Tower' },
      { rank: 3, name: 'Business Bjørn', score: 10800, mapReached: 'Tax Tower' },
      { rank: 4, name: 'Venture Vilde', score: 9500, mapReached: 'Municipal Maze' },
      { rank: 5, name: 'Innovation Ingrid', score: 8900, mapReached: 'Municipal Maze' },
    ],
    month: [
      { rank: 1, name: 'Startup Siri', score: 45600, mapReached: 'Bureaucracy Boss' },
      { rank: 2, name: 'Entrepreneur Erik', score: 43200, mapReached: 'Permit Palace' },
      { rank: 3, name: 'Business Bjørn', score: 39800, mapReached: 'Permit Palace' },
      { rank: 4, name: 'Innovation Ingrid', score: 35400, mapReached: 'Tax Tower' },
      { rank: 5, name: 'Venture Vilde', score: 32100, mapReached: 'Tax Tower' },
    ],
    year: [
      { rank: 1, name: 'Innovation Ingrid', score: 156800, mapReached: 'Bureaucracy Boss' },
      { rank: 2, name: 'Startup Siri', score: 142300, mapReached: 'Bureaucracy Boss' },
      { rank: 3, name: 'Entrepreneur Erik', score: 138900, mapReached: 'Bureaucracy Boss' },
      { rank: 4, name: 'Business Bjørn', score: 125600, mapReached: 'Permit Palace' },
      { rank: 5, name: 'Venture Vilde', score: 119400, mapReached: 'Permit Palace' },
    ],
  };
  ...
  const baseData = mockLeaderboardData[activeFilter as keyof typeof mockLeaderboardData];
  ...
  const filteredData = mapFilter === 'all' 
    ...
    : sortedData.filter(entry => {
        const mapValue = maps.find(m => m.label === entry.mapReached)?.value;
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground">Top entrepreneurs who conquered the bureaucracy</p>
          </div>
          ...
          <Card className="bg-card/50 backdrop-blur-sm border-border">
            <CardHeader>
              <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0">
                <CardTitle className="text-foreground text-2xl">Hall of Fame</CardTitle>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-border">
                    ...
                    <TableHead className="text-muted-foreground">Entrepreneur</TableHead>
                    <TableHead className="text-muted-foreground">Score</TableHead>
                    <TableHead className="text-muted-foreground">Map Reached</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {currentData.map((entry) => (
                    <TableRow key={entry.rank} className="border-border hover:bg-muted/50">
                      ...
                      <TableCell className="text-accent font-bold">{entry.score.toLocaleString()}</TableCell>
                      <TableCell className="text-primary font-medium">{entry.mapReached}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
