...
export const map2: MapDefinition = {
  ...
  monsters: [
    { x: 200, y: 400, type: 'bureaucrat', patrolStartX: 150, patrolEndX: 300, speed: 1 },
    { x: 500, y: 250, type: 'taxman', patrolStartX: 400, patrolEndX: 600, speed: 1.5 }
  ]
};
...
export const map3: MapDefinition = {
  ...
  monsters: [
    { x: 300, y: 420, type: 'regulator', patrolStartX: 250, patrolEndX: 550, speed: 0.8 },
    { x: 150, y: 300, type: 'bureaucrat', patrolStartX: 150, patrolEndX: 650, speed: 1.2 }
  ]
};
